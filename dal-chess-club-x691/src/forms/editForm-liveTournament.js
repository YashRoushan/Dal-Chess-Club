...
function LiveTournamentsEditForm() {
    ...
    const handleEdit = async (tournamentID, title, description, cost, event_imageID, registration_link, start_date, end_date, num_of_participants, locationID, requirements, prizes, tournament_typeID, registration_deadline, cfc_required) => {
        ...
        try {
            ...
            if (result) {
                ...
                console.error('Failed to update live tournament');
            }
        } catch (error) {
            console.error('Error updating live tournament:', error);
        }
    };
    ...
    return (
        <div className="add-form-container">
            ...
            <div className="header-info">
                ...
                <p>This is the page where you, the admin, can edit existing tournaments.</p>
            </div>
...
export default LiveTournamentsEditForm;